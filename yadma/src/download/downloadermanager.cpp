...
//-------------------------------------------------------------------------------
std::string CDownloaderManager::EnumStopped( TEnumStoppedInformation CallBack  )
{
    std::stringstream ss;
    ...
    for( size_t i = 0; i < m_StoppedDownloads.size(); i++ )
    {
        ss << CallBack( &m_StoppedDownloads[i] );
    }
...
//-------------------------------------------------------------------------------
std::string CDownloaderManager::EnumRunning( TEnumDownloadingInformation CallBack  )
{
    std::stringstream ss;
    ...
    for( size_t i = 0; i < m_RunningDownloads.size(); i++ )
    {
        ss << CallBack( m_RunningDownloads[i] );
    }
